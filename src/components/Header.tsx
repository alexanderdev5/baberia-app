...
const Header = () => {
  ...
  const navigation = {
    servicios: [
      { name: "Cortes de Cabello", href: "/servicios/cortes", description: "Estilos modernos y clásicos" },
      { name: "Arreglo de Barba", href: "/servicios/barba", description: "Afeitado tradicional y moderno" },
      { name: "Tatuajes Personalizados", href: "/servicios/tatuajes", description: "Diseños únicos para ti" },
      { name: "Restauración de Tatuajes", href: "/servicios/restauracion", description: "Renueva tu arte" },
      { name: "Piercing y Modificaciones", href: "/servicios/piercing", description: "Profesional y seguro" },
      { name: "Tratamientos Capilares", href: "/servicios/tratamientos", description: "Cuidado especializado" }
    ],
    artistas: [
      { name: "Nuestro Equipo", href: "/artistas/equipo", description: "Conoce a nuestros expertos" },
      { name: "Barberos", href: "/artistas/barberos", description: "Especialistas en estilo" },
      { name: "Tatuadores", href: "/artistas/tatuadores", description: "Artistas del tatuaje" },
      { name: "Portafolios", href: "/artistas/portafolios", description: "Ver nuestro trabajo" },
      { name: "Estilos Especializados", href: "/artistas/estilos", description: "Técnicas únicas" }
    ],
    galeria: [
      { name: "Tatuajes", href: "/galeria/tatuajes", description: "Nuestras obras de arte" },
      { name: "Cortes de Cabello", href: "/galeria/cortes", description: "Transformaciones increíbles" },
      { name: "Barbas", href: "/galeria/barbas", description: "Estilos faciales" },
      { name: "Antes y Después", href: "/galeria/transformaciones", description: "Resultados reales" }
    ],
    precios: [
      { name: "Cortes y Barba", href: "/precios/cortes", description: "Servicios de barbería" },
      { name: "Tatuajes", href: "/precios/tatuajes", description: "Por tamaño y complejidad" },
      { name: "Piercing", href: "/precios/piercing", description: "Variedad de opciones" },
      { name: "Paquetes", href: "/precios/paquetes", description: "Combina servicios" }
    ]
  };

  const mobileMenuItems: MobileMenuItem[] = [
    { name: "Inicio", href: "/", icon: "🏠" },
    { name: "Servicios", href: "#", icon: "✂️", children: navigation.servicios },
    { name: "Artistas", href: "#", icon: "👨‍🎨", children: navigation.artistas },
    { name: "Galería", href: "#", icon: "🖼️", children: navigation.galeria },
    ...
    isScrolled 
        ...
        <nav className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-xl bg-gray-800 text-gray-300 hover:text-white hover:bg-gray-700 transition-all duration-200"
            >
              {isMenuOpen ? (
      ...
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40 bg-black bg-opacity-50 backdrop-blur-sm">
          <div className="fixed inset-y-0 right-0 w-80 bg-gray-900 border-l border-gray-800 shadow-2xl overflow-y-auto">
            {/* Mobile Menu Header */}
            <div className="p-6 border-b border-gray-800">
              <div className="flex items-center justify-between">
                <Link href="/" className="flex items-center space-x-3" onClick={() => setIsMenuOpen(false)}>
                  <div className="bg-gradient-to-br from-red-600 to-red-800 rounded-xl w-12 h-12 flex items-center justify-center text-white font-bold text-xl">
                    U
                  </div>
                  <div>
            ...
            <div className="p-6">
                  ...
                  <div key={index}>
                    {item.children ? (
                      ...
                      <Link
                        href={item.href}
                        onClick={() => setIsMenuOpen(false)}
                        className="flex items-center p-4 rounded-xl bg-gray-800 text-white hover:bg-gray-700 transition-all duration-200 font-medium"
                      >
              ...
              <div className="mt-8 space-y-3">
                <a 
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center justify-center w-full p-4 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-all duration-200 font-medium"
                >
                ...
                <Link 
                  href="/citas" 
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center justify-center w-full p-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-200 font-medium"
                >
  ...
  return (
    <div>
      <button
        ...
        className="flex items-center justify-between w-full p-4 rounded-xl bg-gray-800 text-white hover:bg-gray-700 transition-all duration-200 font-medium"
      >
        <div className="flex items-center">
          <span className="text-lg mr-3">{item.icon}</span>
          {item.name}
        ...
        <div className="ml-4 mt-2 space-y-1 border-l-2 border-gray-700 pl-4">
          {item.children.map((child: NavigationItem, index: number) => (
            <Link
              ...
              href={child.href}
              onClick={onClose}
              className="block p-3 rounded-xl bg-gray-800 text-gray-300 hover:text-white hover:bg-gray-700 transition-all duration-200 text-sm"
            >
              {child.name}
            </Link>
          ))}
